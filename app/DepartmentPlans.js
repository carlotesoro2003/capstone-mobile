...
import Icon from 'react-native-vector-icons/Ionicons'; // Ensure you import Icon
...
const DepartmentPlans = () => {
  ...
  const [filter, setFilter] = useState('all'); // 'all', 'achieved', or 'not achieved'
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.filterContainer}>
        ...
        <TouchableOpacity onPress={() => setFilter('achieved')} style={[styles.filterButton, filter === 'achieved' && styles.activeFilter]}>
          <Text style={styles.filterText}>Achieved</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setFilter('not achieved')} style={[styles.filterButton, filter === 'not achieved' && styles.activeFilter]}>
